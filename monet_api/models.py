...
class ControlDetalle(models.Model):
    ...
    tipo_transaccion = models.CharField(choices=OPCIONES_TIPO_TRANSACCION,max_length=2, null=True)
    valor_transaccion = models.IntegerField(validators=[MaxValueValidator(99999999999999999)])
    indicador_validacion = models.CharField(choices=OPCIONES_INDICADOR,max_length=1 , null=True)
    referencia_1 = models.CharField(max_length=30, null=True)
    referencia_2 = models.CharField(max_length=30, null=True)
    fecha_vencimiento  = models.IntegerField(validators=[MaxValueValidator(99999999)], null=True)
